...
rootProject.extra["spoonacularApiKey"] = localProperties.getProperty("SPOONACULAR_API_KEY")
...
android {
    ...
    defaultConfig {
        ...
        buildConfigField("String", "API_KEY", "\"${rootProject.extra["spoonacularApiKey"]}\"")
    }
